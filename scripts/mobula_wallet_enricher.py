...
def get_wallet_classification(wallet: str, blockchain: str = 'solana') -> dict:
    ...
    data = mobula_request('wallet/portfolio', {
        'wallet': wallet,
    ...
    trader_type = (
        wallet_data.get('trader_type') or
        wallet_data.get('classification') or
    ...
    # Trade count
    result['mobula_trade_count'] = (
        wallet_data.get('trade_count') or
