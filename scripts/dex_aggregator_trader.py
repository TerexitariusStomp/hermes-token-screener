...
def acquire_lock():
    ...
    if os.path.exists(LOCKFILE):
        try:
            ...
            print(f"[LOCK] Instance already running (PID {old_pid}), exiting.", file=sys.stderr)
            sys.exit(0)
            ...
            print(f"[LOCK] Instance running (PID {old_pid}, permission denied), exiting.", file=sys.stderr)
            sys.exit(0)
...
class DexAggregatorTrader:
    ...
    def jupiter_quote(self, input_mint: str, output_mint: str, amount: int, slippage_bps: int = 50) -> Dict:
        ...
        try:
            resp = requests.get(f"{self.JUPITER_API}/quote", params={
                "inputMint": input_mint,
                "outputMint": output_mint,
                "amount": str(amount),
                "slippageBps": slippage_bps,
            }, headers={"x-api-key": self.JUPITER_API_KEY}, timeout=10)
            return resp.json()
        except Exception as e:
    ...
    def jupiter_swap(self, quote: Dict, wallet: str) -> Dict:
        ...
        try:
            resp = requests.post(f"{self.JUPITER_API}/swap", json={
                "quoteResponse": quote,
                "userPublicKey": wallet,
                "wrapAndUnwrapSol": True,
            }, headers={"x-api-key": self.JUPITER_API_KEY}, timeout=30)
            return resp.json()
        except Exception as e:
    ...
    def kyberswap_quote(self, chain: str, token_in: str, token_out: str, amount: str) -> Dict:
        ...
        try:
            resp = requests.get(f"{self.KYBERSWAP_API}/{chain_id}/api/v1/routes", params={
                "tokenIn": token_in,
                "tokenOut": token_out,
                "amountIn": amount,
            }, timeout=10)
    ...
    def kyberswap_build(self, chain: str, route: Dict, sender: str, recipient: str, slippage: int = 50) -> Dict:
        ...
        chain_id = chain_ids.get(chain, "base")
        try:
            resp = requests.post(f"{self.KYBERSWAP_API}/{chain_id}/api/v1/route/build", json={
                "routeSummary": route,
                "sender": sender,
                "recipient": recipient,
    ...
    def lifi_quote(self, from_chain: str, to_chain: str, from_token: str, to_token: str, 
                   from_amount: str, from_address: str) -> Dict:
        """Get quote from LiFi."""
        try:
            resp = requests.get(f"{self.LIFI_API}/quote", params={
            ...
            }, headers={"x-lifi-api-key": self.LIFI_API_KEY}, timeout=15)
            return resp.json()
        except Exception as e:
    ...
    def lifi_chains(self) -> List[Dict]:
        ...
        try:
            resp = requests.get(f"{self.LIFI_API}/chains", 
                              headers={"x-lifi-api-key": self.LIFI_API_KEY}, timeout=10)
    ...
    def openocean_quote(self, chain: str, in_token: str, out_token: str, amount: str, 
                        gas_price: str = "5") -> Dict:
        ...
        try:
            resp = requests.get(f"{self.OPENOCEAN_API}/{chain_id}/quote", params={
    ...
    def velora_quote(self, chain: int, src_token: str, dest_token: str, amount: str,
                     src_decimals: int = 18, dest_decimals: int = 18) -> Dict:
        """Get quote from Velora (ParaSwap)."""
        try:
            resp = requests.get(f"{self.VELORA_API}/prices", params={
                "srcToken": src_token,
    ...
    def portals_quote(self, chain: str, token_in: str, token_out: str, amount: str) -> Dict:
        ...
        try:
            ...
            resp = requests.get(f"{self.PORTALS_API}/quote", params={
                "chainId": chain_id,
                "tokenIn": token_in,
                "tokenOut": token_out,
                "amountIn": amount,
    ...
    def enso_quote(self, chain: str, token_in: str, token_out: str, amount: str) -> Dict:
        ...
        try:
            resp = requests.get(f"{self.ENSO_API}/route", params={
                "chainId": chain_id,
                "tokenIn": token_in,
                "tokenOut": token_out,
                "amountIn": amount,
    ...
    def odos_quote(self, chain: str, token_in: str, token_out: str, amount: str,
                   wallet: str = "") -> Dict:
        """Get quote from Odos."""
        chain_ids = {
            "base": 8453,
        ...
        try:
            resp = requests.post(f"{self.ODOS_API}/sor/quote/v2", json={
                "chainId": chain_id,
    ...
    def odos_assemble(self, path_id: str, wallet: str = "") -> Dict:
        ...
        if not wallet:
            wallet = self.evm_account.address if self.evm_account else ""
        try:
            resp = requests.post(f"{self.ODOS_API}/sor/assemble", json={
                "pathId": path_id,
                "simulate": False,
                "userAddr": wallet,
            }, timeout=15)
    ...
    def cow_quote(self, token_in: str, token_out: str, amount: str) -> Dict:
        ...
        try:
            resp = requests.post(f"{self.COW_API}/api/v1/quote", json={
                "sellToken": token_in,
                "buyToken": token_out,
    ...
    def raydium_quote(self, input_mint: str, output_mint: str, amount: int,
                      slippage_bps: int = 50) -> Dict:
        """Get quote from Raydium (Solana)."""
        try:
            resp = requests.get(f"{self.RAYDIUM_API}/compute/swap-base-in", params={
                "inputMint": input_mint,
                "outputMint": output_mint,
                "amount": str(amount),
    ...
    def jupiter_v1_quote(self, input_mint: str, output_mint: str, amount: int,
                         slippage_bps: int = 50) -> Dict:
        """Get quote from Jupiter v1 API (fallback when v6 blocked)."""
        try:
            resp = requests.get(f"{self.JUPITER_API_V1}/quote", params={
                "inputMint": input_mint,
                "outputMint": output_mint,
                "amount": str(amount),
                "slippageBps": slippage_bps,
    ...
    def oku_quote(self, chain: str, token_in: str, token_out: str, amount: str) -> Dict:
        ...
        try:
            resp = requests.get(f"{self.OKU_API}/{chain_name}/quote", params={
                "tokenIn": token_in,
                "tokenOut": token_out,
                "amount": amount,
            }, timeout=15)
    ...
    def get_pool_info(self, token_a: str, token_b: str, chain: str = "base") -> Dict:
        ...
        # KyberSwap pool info
        try:
            resp = requests.get(f"{self.KYBERSWAP_API}/{chain}/api/v1/pools", params={
                "tokenIn": token_a,
                "tokenOut": token_b,
            }, timeout=15)
    ...
    def add_liquidity_quote(self, token_a: str, token_b: str, amount_a: str, chain: str = "base") -> Dict:
    ...
    def add_liquidity(self, token_a: str, token_b: str, amount_a: str, amount_b: str, chain: str = "base") -> bool:
        """Add liquidity to a pool."""
        logger.info(f"Adding liquidity: {amount_a} {token_a} + {amount_b} {token_b} on {chain}")
    ...
    def create_limit_order(self, token_in: str, token_out: str, amount: str, 
                           target_price: str, chain: str = "base") -> Dict:
        """Create a limit order."""
        logger.info(f"Creating limit order: {amount} {token_in} -> {token_out} at price {target_price}")
        
        # Oku supports limit orders
        try:
            resp = requests.post(f"{self.OKU_API}/{chain}/limit-order", json={
                "tokenIn": token_in,
                "tokenOut": token_out,
                "amountIn": amount,
    ...
    def create_dca_order(self, token: str, amount_per_interval: str, 
                         intervals: int, chain: str = "base") -> Dict:
        ...
        try:
            resp = requests.post(f"{self.ENSO_API}/dca", json={
                "token": token,
    ...
    def compare_quotes(self, chain: str, token_in: str, token_out: str, amount: str) -> Dict:
        ...
        if chain == "solana":
            ...
            # LiFi (multi-chain)
            lifi_quote = self.lifi_quote(chain, chain, token_in, token_out, amount,
            ...
            if lifi_quote and "estimate" in lifi_quote:
                ...
                if isinstance(estimate, dict):
                    quotes["lifi"] = {
                        ...
                        "gas_cost_usd": estimate.get("gasCosts", [{}])[0].get("amountUSD", "0") if estimate.get("gasCosts") else "0",
                    }
        ...
        try:
            ...
            if self.w3:
                tx = {
                    ...
                    "to": router_address,
                    "data": calldata,
                    "value": int(transaction_value, 16) if isinstance(transaction_value, str) and transaction_value.startswith("0x") else int(transaction_value),
                    "gas": int(tx_data.get("gas", 300000)),
                    "maxFeePerGas": self.w3.eth.gas_price,
                    "maxPriorityFeePerGas": self.w3.eth.max_priority_fee,
                    "nonce": self.w3.eth.get_transaction_count(self.evm_account.address, "pending"),
        ...
        try:
            ...
            if self.w3:
                ...
                tx_data = {
                    ...
                    "to": tx.get("to"),
                    "data": tx.get("data"),
                    "value": int(tx.get("value", "0"), 16) if isinstance(tx.get("value"), str) and tx.get("value", "").startswith("0x") else int(tx.get("value", "0")),
        ...
        while True:
            try:
                ...
                if base_bal > Decimal("0.001") and sol_bal < Decimal("0.01"):
                    ...
                    bridge_quote = self.bridge_quote("base", "solana", "0x4200000000000000000000000000000000000006", bridge_amount)
                    if bridge_quote:
                    ...
                    bridge_quote = self.bridge_quote("solana", "base", "So11111111111111111111111111111111111111112", bridge_amount)
                    if bridge_quote:
                        logger.info(f"Bridge quote available: {bridge_quote.get('estimate', {}).get('toAmount', 'N/A')}")
