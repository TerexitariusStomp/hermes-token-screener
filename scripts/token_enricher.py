...
def score_and_output(enriched: list) -> list:
    """Score enriched tokens, sort, save to OUTPUT_PATH, and return top tokens."""
    from pathlib import Path
    import json
    ...
    log.info(f"Scored {len(top)} tokens, saved to {OUTPUT_PATH}")
    return top
