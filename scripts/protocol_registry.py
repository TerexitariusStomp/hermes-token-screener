...
ODOS_ROUTER_ABI = [
    {"type":"function","name":"swap","stateMutability":"payable",
     "inputs":[
         ...
         {"name":"inputAmounts","type":"tuple","components":[
             {"name":"tokenAddress","type":"address"},{"name":"amount","type":"uint256"}]},
         {"name":"outputAmounts","type":"tuple","components":[
             {"name":"tokenAddress","type":"address"},{"name":"amount","type":"uint256"}]},
...
COW_SETTLEMENT_ABI = [
    {"type":"function","name":"setPreSignature","stateMutability":"nonpayable",
     "inputs":[{"name":"orderUid","type":"bytes32"},{"name":"signed","type":"bool"}],
     "outputs":[]},
]
...
SUSHI_ROUTER_ABI = [
    {"type":"function","name":"processRoute","stateMutability":"payable",
     "inputs":[
         {"name":"tokenIn","type":"address"},{"name":"amountIn","type":"uint256"},
         {"name":"tokenOut","type":"address"},{"name":"amountOutMin","type":"uint256"},
         {"name":"to","type":"address"},{"name":"route","type":"bytes"}
     ],
     "outputs":[{"name":"amountOut","type":"uint256"}]},
    {"type":"function","name":"processRouteWithTransferValue","stateMutability":"payable",
     "inputs":[
         {"name":"tokenIn","type":"address"},{"name":"amountIn","type":"uint256"},
         {"name":"tokenOut","type":"address"},{"name":"amountOutMin","type":"uint256"},
         {"name":"to","type":"address"},{"name":"route","type":"bytes"},
...
PARASWAP_ABI = [
    {"type":"function","name":"simpleSwap","stateMutability":"payable",
     "inputs":[
         {"name":"fromToken","type":"address"},{"name":"toToken","type":"address"},
         {"name":"fromAmount","type":"uint256"},{"name":"toAmount","type":"uint256"},
         {"name":"expectedAmount","type":"uint256"},{"name":"callees","type":"address[]"},
...
LIFI_DIAMOND_ABI = [
    {"type":"function","name":"swapTokensSingleStepBridge","stateMutability":"payable",
     "inputs":[
         {"name":"_swapData","type":"tuple","components":[
...
TOKEN_REGISTRY = {
    "base": {
        ...
        "ANDY": {"address": "0x029Eb076D2E9E5b2dDc1aB7BDe2D5d3b4b1bfAA0", "decimals": 18, "symbol": "ANDY"},
    },
    "solana": {
        ...
        "WIF": {"address": "EKpQGSJtjMFqKZ9KQanSqYXRcF8fBopzLHYxdM65zcjm", "decimals": 6, "symbol": "WIF"},
        "POPCAT": {"address": "7GCihgDB8fe6KNjn2MYtkzZcRjQy3t9GHdC8uHYmW2hr", "decimals": 9, "symbol": "POPCAT"},
    }
}
