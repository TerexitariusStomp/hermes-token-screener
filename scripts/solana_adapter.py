...
class SolanaProgramAdapter:
    ...
    def jupiter_quote(self, input_mint: str, output_mint: str,
                      amount: int, slippage_bps: int = 50) -> Dict:
        """Get quote from Jupiter API v1."""
        try:
            resp = requests.get("https://api.jup.ag/swap/v1/quote", params={
    ...
    def jupiter_build_tx(self, quote: Dict, wrap_unwrap: bool = True) -> Optional[VersionedTransaction]:
        """
        ...
        try:
            ...
            resp = requests.post("https://api.jup.ag/swap/v1/swap-instructions", json={
                "quoteResponse": quote,
    ...
    def send_tx(self, tx: VersionedTransaction, skip_preflight: bool = False) -> Optional[str]:
    ...
    def swap_by_symbol(self, from_symbol: str, to_symbol: str,
                       amount_ui: float, slippage_bps: int = 50) -> Optional[str]:
    ...
    def raydium_cpmm_quote(self, input_mint: str, output_mint: str,
                           amount: int, slippage_bps: int = 50) -> Dict:
        """Get quote from Raydium CPMM API."""
        try:
            resp = requests.get("https://transaction-v1.raydium.io/compute/swap-base-in", params={
                "inputMint": input_mint,
                "outputMint": output_mint,
                "amount": str(amount),
    ...
    def compare_quotes(self, input_mint: str, output_mint: str,
                       amount: int, slippage_bps: int = 50) -> Dict:
