...
class TemplateStorage:
    ...
    def load_template(self, name: str) -> Optional[TemplateEntry]:
    ...
    def get_best_template(self, name: str) -> Optional[str]:
        ...
        best = max(
            variants + [{"content": data.get("content", ""), "version": data.get("metadata", {}).get("version", 0)}],
    ...
    def copy_as_variant(self, name: str, variant_name: str, modifications: str = "") -> Optional[str]:
